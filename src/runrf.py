...
from deep_dialog.agents import AgentCmd, InformAgent, RequestAllAgent, RandomAgent, EchoAgent, RequestBasicsAgent, AgentRF
...
def run_episodes(count, status):
    ...
    if agt == 7 and params['trained_model_path'] == None and warm_start == 1:
    ...
    for episode in xrange(count):
        ...
        # simulation
        if agt == 7 and params['trained_model_path'] == None:
            ...
            # AgentRF.train(batch_size, 1)
            agent.train(batch_size, 1)
            agent.reset_rf_target()
